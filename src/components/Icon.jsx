export default function Icon({ name, size = 16, strokeWidth = 1.8, color = "currentColor" }) {
  const d = {
    ...
    "file-text":<><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></>,
    ...
    "file-pdf": <><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 15c0 1.1.9 2 2 2h2"/><path d="M9 12h6"/></>,
    sparkle:    <><path d="M12 3v1m0 16v1M3 12h1m16 0h1"/><path d="M5.6 5.6l.7.7m11.4 11.4.7.7M5.6 18.4l.7-.7m11.4-11.4.7-.7"/><circle cx="12" cy="12" r="3"/></>,
    ...
    habilitacao:<><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><polyline points="9 12 11 14 15 10"/></>,
